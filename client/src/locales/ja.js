export default {
  ...
  restocking: {
    title: '補充発注',
    description: '需要予測と予算に基づいて補充すべき品目を提案します',
    budget: '利用可能予算',
    selectedCost: '選択品目の合計',
    itemsSelected: '選択品目数',
    recommendations: '補充推奨品目',
    placeOrder: '発注する',
    placingOrder: '発注中...',
    orderPlaced: '注文 {orderNumber} を発注しました。注文タブでご確認ください。',
    orderFailed: '発注に失敗しました',
    noRecommendations: '現在の需要予測では補充が必要な品目はありません。',
    withinBudget: '予算内',
    overBudget: '予算超過',
    table: {
      sku: 'SKU',
  ...
  backlog: {
    ...
    items: 'バックログ品目',
    noBacklog: 'バックログ品目なし - すべての注文を履行できます！',
    table: {
      orderId: '注文ID',
      sku: 'SKU',
      itemName: '品目名',
